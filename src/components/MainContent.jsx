        ...
        <div>
            <main className="bg-custom-gray h-[25rem]">
                <section className="flex flex-col items-center pt-4">
                    ...
                    <h4 className="text-off-white pt-2 text-[0.6rem]">laurasmith.website</h4>
                ...
                <section className="flex flex-col w-60 h-48 mx-auto text-off-gray">
                    ...
                    <p className="pt-1 text-[0.6rem]">Food expert. Music scholar. Reader. Internet fanatic. Bacon buff. Entrepreneur. Travel geek. Pop culture ninja. Coffee fanatic.</p>
                </section>
            </main>
        </div>
    )
